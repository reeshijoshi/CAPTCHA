...
path="C:/captcha-demo-master/Polly0-Z"
dest = "C:/captcha-demo-master/Polly0-ZImage"
...
for audio in files:
    ...
    plt.savefig(os.path.join(dest, (os.path.splitext(audio)[0]).replace(" ", "")+'.png'), bbox_inches=None, pad_inches=0)
    count = count+1
    print(count)
    plt.close()